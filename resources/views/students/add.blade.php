            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <em class="bi bi-person-lines-fill"></em> Add Student
                    </h1>
                    ...
                    <p class="text-primary">
                        <small><em class="bi bi-exclamation-diamond-fill me-2"></em> Remember to create related "Class" and "Section" before adding student</small>
                    </p>
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <label for="inputFirstName" class="form-label">First Name<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputLastName" class="form-label">Last Name<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    <input type="text" class="form-control" id="inputLastName" name="last_name" placeholder="Last Name" required value="{{old('last_name')}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="inputEmail4" class="form-label">Email<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    <input type="email" class="form-control" id="inputEmail4" name="email" required value="{{old('email')}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="inputPassword4" class="form-label">Password<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputBirthday" class="form-label">Birthday<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    <input type="date" class="form-control" id="inputBirthday" name="birthday" placeholder="Birthday" required value="{{old('birthday')}}">
                                </div>
                                <div class="col-3-md">
                                    <label for="inputAddress" class="form-label">Address<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputCity" class="form-label">City<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="Dhaka..." required value="{{old('city')}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputZip" class="form-label">Zip<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    <input type="text" class="form-control" id="inputZip" name="zip" required value="{{old('zip')}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="inputState" class="form-label">Gender<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputNationality" class="form-label">Nationality<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-4">
                                    <label for="inputBloodType" class="form-label">BloodType<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-4">
                                    <label for="inputReligion" class="form-label">Religion<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-4">
                                    <label for="inputPhone" class="form-label">Phone<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="+880 01......" required value="{{old('phone')}}">
                                </div>
                                <div class="col-5-md">
                                    <label for="inputIdCardNumber" class="form-label">Id Card Number<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-3">
                                    <label for="inputFatherName" class="form-label">Father Name<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputFatherPhone" class="form-label">Father's Phone<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputMotherName" class="form-label">Mother Name<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-3">
                                    <label for="inputMotherPhone" class="form-label">Mother's Phone<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-4-md">
                                    <label for="inputParentAddress" class="form-label">Address<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="inputAssignToClass" class="form-label">Assign to class:<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                ...
                                <div class="col-md-6">
                                    <label for="inputAssignToSection" class="form-label">Assign to section:<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                            ...
                            <div class="row mt-4">
                                <div class="col-12-md">
                                    <button type="submit" class="btn btn-sm btn-outline-primary"><em class="bi bi-person-plus"></em> Add</button>
                                </div>
                            </div>
                        </form>
                    </div>
