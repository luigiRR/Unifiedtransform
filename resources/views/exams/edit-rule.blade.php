...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><em class="bi bi-file-plus"></em> Edit Exam Rule</h1>
                        ...
                        <div class="col-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('exam.rule.update')}}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <label for="inputTotalMarks" class="form-label">Total Marks<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                        <input type="number" class="form-control" id="inputTotalMarks" value="{{$exam_rule->total_marks}}" name="total_marks" step="0.01">
                                    </div>
                                    <div class="mt-2">
                                        <label for="inputPassMarks" class="form-label">Pass Marks<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                        <input type="number" class="form-control" id="inputPassMarks" value="{{$exam_rule->pass_marks}}" name="pass_marks" step="0.01">
                                    </div>
                                    <div class="mt-2">
                                        <label for="inputMarksDistributionNote" class="form-label">Marks Distribution Note<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                    ...
                                    <button type="submit" class="mt-3 btn btn-sm btn-outline-primary"><em class="bi bi-check"></em> Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
