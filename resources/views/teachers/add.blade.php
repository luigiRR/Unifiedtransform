            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <em class="bi bi-person-lines-fill"></em> Add Teacher
                    </h1>
                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.teacher.create')}}" method="POST">
                            ...
                            <div class="col-md-6">
                                <label for="inputEmail" class="form-label">Email<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                                <input type="email" class="form-control" id="inputEmail" name="email" required value="{{old('email')}}">
                            </div>
                            <div class="col-md-6">
                                <label for="inputPassword" class="form-label">Password<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
                            ...
                            <div class="col-md-4">
                                <label for="inputGender" class="form-label">Gender<sup><em class="bi bi-asterisk text-primary"></em></sup></label>
